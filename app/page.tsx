    ...
    <>
      ...
      <section className="bg-hero border-b border-line">
        <div className="mx-auto max-w-6xl px-4 pb-20 pt-16 sm:pt-24">
          ...
          <div className="mt-9 flex flex-wrap gap-4">
            <Link
              href="/contacts"
              className="rounded-xl bg-accent px-7 py-3.5 font-bold text-background transition-colors hover:bg-accent-2"
            >
              Подобрать авто
            </Link>
            <Link
          ...
          <div className="mt-16 grid grid-cols-2 gap-4 sm:grid-cols-4">
            {[
              ...
              <div key={big} className="rounded-xl border border-line bg-surface/60 p-4">
      ...
      <section className="border-y border-line bg-surface/40">
        <div className="mx-auto max-w-6xl px-4 py-16">
          ...
          <div className="mt-10 grid gap-5 sm:grid-cols-2">
            {WHY.map((w) => (
              <div key={w.title} className="flex gap-5 rounded-2xl border border-line bg-surface p-6">
      ...
      <section className="mx-auto max-w-6xl px-4 py-16">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
          {GEO.map((g) => (
            <div key={g.country} className="rounded-2xl border border-line bg-surface p-5 text-center">
