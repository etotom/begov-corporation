...
const SERVICES = [
  {
    ...
    text: "Закупаем на аукционах США (в том числе Copart, IAAI, Manheim), в Европе и на рынке ОАЭ. Анализируем историю лота, оцениваем повреждения и реальную стоимость восстановления, торгуемся за вас и выкупаем авто.",
    points: ["Отчет по каждому лоту до ставки", "Ставки в рамках вашего бюджета", "Оплата по договору"],
  },
  {
    title: "Международная логистика",
    text: "Организуем доставку из США и ОАЭ морем до Поти, из Европы — автовозом или морем. Можем организовать страхование груза по запросу, отслеживаем контейнер и держим вас в курсе на каждом этапе.",
  ...
  },
  {
    ...
    points: ["Свой автопарк", "Опытные водители и проверенные маршруты", "Страхование по запросу"],
  },
  {
